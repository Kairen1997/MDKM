...
<head>
	...
	<title>Air Terjun Hatob - Majlis Daerah Kota Marudu</title>
	...
	<meta name="description" content="Air Terjun Hatob di Kota Marudu – air terjun hutan dengan suasana semula jadi yang menenangkan dan sesuai untuk rekreasi serta fotografi.">
</head>
<body>
	...
	<main class="main-content">
		<div class="page-title">Air Terjun Hatob</div>

		<section class="intro-grid">
			<div>
				<div class="gallery">
					<figure>
						<img src="images/air terjun hatob 1.png" alt="Air Terjun Hatob - aliran air terjun di hutan" />
					</figure>
				</div>
				<div class="info-card">
					<strong>Maklumat penting</strong><br>
					Lokasi: Kota Marudu, Sabah.<br>
					Aktiviti: Berkelah, fotografi, menikmati alam semula jadi.<br>
			...
			<article class="content-card">
				<h2>Pengenalan</h2>
				<p>
					Air Terjun Hatob menawarkan suasana rimba yang tenang dengan aliran air yang
					jernih melalui bongkah batu semula jadi. Ia menjadi lokasi santai untuk keluarga
					dan rakan-rakan menikmati udara segar serta merakam momen indah.
				</p>
				<ul>
					<li>Laluan hutan pendek dengan pemandangan hijau</li>
					<li>Kolam cetek sesuai berendam santai</li>
					<li>Spot fotografi semula jadi</li>
				</ul>
				<p>
					Utamakan keselamatan ketika permukaan licin, bawa pulang sampah dan hormati alam.
				</p>
			</article>
		</section>
		...
		<section class="map-card" aria-label="Lokasi di Google Maps">
			<div class="map-responsive">
				<iframe
					src="https://www.google.com/maps?q=Air%20Terjun%20Hatob%20Kota%20Marudu&output=embed"
					loading="lazy"
					referrerpolicy="no-referrer-when-downgrade"
					allowfullscreen
					title="Peta Air Terjun Hatob">
				</iframe>
			</div>
		</section>
	</main>
