...
<head>
    ...
    <title>Sarangheyo - Campground - Majlis Daerah Kota Marudu</title>
    ...
    <meta name="description" content="Sarangheyo - Campground di Kota Marudu – lokasi perkhemahan mesra keluarga dengan pemandangan alam semula jadi.">
</head>
<body>
    ...
    <main class="main-content">
        <div class="page-title">Sarangheyo - Campground</div>
        ...
        <section class="intro-grid">
            <div>
                ...
                <div class="info-card">
                    ...
                    Lokasi: Sarangheyo - Campground, Kota Marudu.<br>
                    Aktiviti: Perkhemahan, BBQ, melihat bintang, gambar pemandangan.<br>
                    Waktu sesuai: Petang hingga malam untuk langit berbintang.<br>
                    Saranan: Tempah awal dan bawa peralatan camping yang mencukupi.
                </div>
            </div>
            ...
            <article class="content-card">
                <h2>Pengenalan</h2>
                <p>
                    Sarangheyo - Campground menawarkan pengalaman berkhemah yang selesa dengan
                    suasana alam semula jadi serta pemandangan indah di sekitarnya. Lokasi ini amat
                    sesuai untuk keluarga dan kumpulan rakan yang ingin menikmati percutian ringkas.
                </p>
                <ul>
                    <li>Tapak kem yang teratur dan mesra keluarga</li>
                    <li>Spot fotografi malam (milky way) ketika cuaca baik</li>
                    <li>Kemudahan asas: tandas, pondok rehat, kawasan BBQ</li>
                </ul>
                <p>
                    Pengunjung digalakkan menjaga kebersihan dan mematuhi garis panduan keselamatan
                    yang disediakan oleh pengusaha tapak.
                </p>
            </article>
        </section>
    </main>
