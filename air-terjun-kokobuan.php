...
<head>
	...
	<title>Air Terjun Kokobuan - Majlis Daerah Kota Marudu</title>
	...
	<meta name="description" content="Air Terjun Kokobuan di Kota Marudu – taman rekreasi hutan dengan air terjun yang menenangkan, sesuai untuk berkelah dan fotografi alam.">
</head>
<body>
	...
	<main class="main-content">
		<div class="page-title">Air Terjun Kokobuan</div>

		<section class="intro-grid">
			<div>
				<div class="gallery">
					<figure>
						<img src="images/air terjun kokobuan.jpg" alt="Air Terjun Kokobuan - papan tanda taman rekreasi" />
					</figure>
					<figure>
						<img src="images/air terjun kokobuan 2.jpg" alt="Air Terjun Kokobuan - air terjun dan kolam semula jadi" />
					</figure>
				</div>
				<div class="info-card">
					<strong>Maklumat penting</strong><br>
					Lokasi: Kota Marudu, Sabah.<br>
					Aktiviti: Berkelah, meredah hutan ringan, fotografi alam.<br>
					Waktu sesuai: Pagi hingga petang, cuaca baik.
				</div>
			</div>
			...
			<article class="content-card">
				<h2>Pengenalan</h2>
				<p>
					Air Terjun Kokobuan terletak di kawasan hutan simpan yang hijau dan damai.
					Aliran air yang jernih membentuk kolam semula jadi yang sesuai untuk berendam
					santai. Persekitaran rimba yang kaya dengan flora menjadikannya lokasi ideal
					buat keluarga dan rakan-rakan menikmati alam.
				</p>
				<ul>
					<li>Laluan hutan mesra keluarga</li>
					<li>Kolam air semula jadi yang tenang</li>
					<li>Spot fotografi hijau dan air terjun</li>
				</ul>
				<p>
					Utamakan keselamatan ketika permukaan licin dan sentiasa jaga kebersihan.
				</p>
			</article>
		</section>
		...
		<section class="map-card" aria-label="Lokasi di Google Maps">
			<div class="map-responsive">
				<iframe
					src="https://www.google.com/maps?q=Air%20Terjun%20Kokobuan%20Kota%20Marudu&output=embed"
					loading="lazy"
					referrerpolicy="no-referrer-when-downgrade"
					allowfullscreen
					title="Peta Air Terjun Kokobuan">
				</iframe>
			</div>
		</section>
	</main>
