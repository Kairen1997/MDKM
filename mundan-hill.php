...
<head>
	...
	<title>Mundan Hill - Majlis Daerah Kota Marudu</title>
	...
	<meta name="description" content="Mundan Hill di Kota Marudu – bukit tumpuan pendakian santai dengan pemandangan panorama dan spot fotografi menarik.">
</head>
<body>
	...
	<main class="main-content">
		<div class="page-title">Mundan Hill</div>

		<section class="intro-grid">
			<div>
				<div class="gallery">
					<figure>
						<img src="images/mundan hill 1.png" alt="Mundan Hill - papan tanda dan pemandangan lembah">
					</figure>
					<figure>
						<img src="images/mundan hill 2.png" alt="Mundan Hill - pemandangan puncak dengan bendera dan struktur">
					</figure>
				</div>
				<div class="info-card">
					<strong>Maklumat penting</strong><br>
					Lokasi: Kota Marudu, Sabah.<br>
					Aktiviti: Pendakian santai, melihat matahari terbit/terbenam, fotografi panorama.<br>
					Waktu sesuai: Pagi awal atau lewat petang.
				</div>
			</div>
			...
			<article class="content-card">
				<h2>Pengenalan</h2>
				<p>
					Mundan Hill merupakan bukit tumpuan pendakian santai di Kota Marudu dengan
					pemandangan luas sawah dan perkampungan. Laluan yang mesra keluarga,
					dilengkapi spot bergambar di puncak menjadikannya lokasi hujung minggu yang ideal.
				</p>
				<ul>
					<li>Laluan ringkas sesuai untuk kebanyakan peringkat umur</li>
					<li>Spot foto kreatif di puncak</li>
					<li>Pemandangan panorama 360°</li>
				</ul>
				<p>
					Bawa air mencukupi, pakai kasut yang sesuai, dan jaga kebersihan. Sentiasa
					berhati-hati ketika cuaca hujan kerana laluan mungkin licin.
				</p>
			</article>
		</section>
		...
		<section class="map-card" aria-label="Lokasi di Google Maps">
			<div class="map-responsive">
				<iframe
					src="https://www.google.com/maps?q=Mundan%20Hill%20Kota%20Marudu&output=embed"
					loading="lazy"
					referrerpolicy="no-referrer-when-downgrade"
					allowfullscreen
					title="Peta Mundan Hill">
				</iframe>
			</div>
		</section>
	</main>
