...
<head>
    ...
    <title>Dasar Privasi - Majlis Daerah Kota Marudu</title>
...
<body>
    ...
    <header class="header">
        ...
        <div class="page-title">Dasar Privasi</div>
    </header>

    <main class="main-content">
        <section class="section">
            <h2 class="section-title">Dasar Privasi MDKM</h2>
            <p>Halaman ini menerangkan bagaimana Majlis Daerah Kota Marudu (MDKM) mengumpul, menggunakan, melindungi dan memproses data peribadi anda selaras dengan undang-undang dan amalan terbaik.</p>
            <p>Isi kandungan terperinci boleh dikemas kini kemudian mengikut keperluan pihak MDKM.</p>
        </section>
    </main>
