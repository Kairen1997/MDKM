...
<head>
	...
	<title>Gumagayo River Park - Majlis Daerah Kota Marudu</title>
	...
	<meta name="description" content="Gumagayo River Park di Kota Marudu – lokasi rekreasi sungai dengan aktiviti mandi-manda, lompatan tali dan santai alam semula jadi.">
</head>
<body>
	...
	<main class="main-content">
		<div class="page-title">Gumagayo River Park</div>

		<section class="intro-grid">
			<div>
				<div class="gallery">
					<figure>
						<img src="images/gumagayo river park 1.png" alt="Gumagayo River Park - aktiviti terjun tali di sungai">
					</figure>
				</div>
				<div class="info-card">
					<strong>Maklumat penting</strong><br>
					Lokasi: Kota Marudu, Sabah.<br>
					Aktiviti: Mandi-manda, berkelah, lompatan tali, fotografi alam.<br>
					Waktu sesuai: Pagi & petang; elak hujan lebat.
				</div>
			</div>
			...
			<article class="content-card">
				<h2>Pengenalan</h2>
				<p>
					Gumagayo River Park merupakan destinasi rekreasi sungai yang popular untuk
					aktiviti bersama keluarga dan rakan. Air yang jernih, kawasan berteduh, serta
					platform ringkas untuk lompatan tali menjadikannya lokasi santai hujung minggu.
				</p>
				<ul>
					<li>Mandi-manda dan berkelah di tepi sungai</li>
					<li>Spot foto semula jadi dengan kehijauan hutan</li>
					<li>Aktiviti lompatan tali bagi yang berpengalaman</li>
				</ul>
				<p>
					Utamakan keselamatan: nilai arus sungai terlebih dahulu, pastikan pengawasan kanak-kanak,
					dan elakkan terjun di kawasan cetek atau berbatu. Bawa pulang semula sampah dan
					jaga kebersihan alam sekitar.
				</p>
			</article>
		</section>
		...
		<section class="map-card" aria-label="Lokasi di Google Maps">
			<div class="map-responsive">
				<iframe
					src="https://www.google.com/maps?q=Gumagayo%20River%20Park%20Kota%20Marudu&output=embed"
					loading="lazy"
					referrerpolicy="no-referrer-when-downgrade"
					allowfullscreen
					title="Peta Gumagayo River Park">
				</iframe>
			</div>
		</section>
	</main>
