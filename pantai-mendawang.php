...
<head>
    ...
    <title>Pantai Mendawang - Majlis Daerah Kota Marudu</title>
    ...
    <meta name="description" content="Pantai Mendawang di Kota Marudu – pantai semula jadi dengan suasana damai untuk berkelah dan rekreasi keluarga.">
</head>
<body>
    ...
    <main class="main-content">
        <div class="page-title">Pantai Mendawang</div>

        <section class="intro-grid">
            <div>
                <div class="gallery">
                    <figure>
						<img src="images/Pantai%20mendawang%201.jpg" alt="Pantai Mendawang - pemandangan pantai dan laut">
                    </figure>
                    <figure>
						<img src="images/Pantai%20mendawang%202.jpg" alt="Pantai Mendawang - suasana santai dan pesisir">
                    </figure>
                </div>
                <div class="info-card">
                    <strong>Maklumat penting</strong><br>
                    Lokasi: Pantai Mendawang, Kota Marudu.<br>
                    Aktiviti: Berkelah, berjalan di pesisir, fotografi senja.<br>
                    Waktu sesuai: Pagi & petang.<br>
                    Saranan: Bawa bekalan air, jaga kebersihan pantai.
                </div>
            </div>
            ...
            <article class="content-card">
                <h2>Pengenalan</h2>
                <p>
                    Pantai Mendawang merupakan antara pesisir semula jadi di Kota Marudu yang
                    menawarkan suasana damai dengan tiupan angin laut dan pemandangan yang indah.
                    Ia sesuai untuk aktiviti santai bersama keluarga dan rakan.
                </p>
                <ul>
                    <li>Garis pantai yang panjang, sesuai untuk berjalan santai</li>
                    <li>Spot fotografi matahari terbenam</li>
                    <li>Persekitaran semula jadi yang tenang</li>
                </ul>
                <p>
                    Pengunjung digalakkan mematuhi amalan kebersihan dan keselamatan ketika berada di
                    pantai bagi menjaga kelestarian alam sekitar.
                </p>
            </article>
        </section>
    </main>
