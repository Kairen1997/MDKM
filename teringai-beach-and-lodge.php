	...
	<main class="main-content">
		...
		<section class="intro-grid">
			<div>
				<div class="gallery">
					<figure>
						<img src="teringai 1.png" alt="Teringai Beach and Lodge - pemandangan pantai dan penginapan">
					</figure>
					<figure>
						<img src="teringai 2.png" alt="Teringai Beach and Lodge - suasana santai tepi pantai">
					</figure>
				</div>
				<div class="info-card">
