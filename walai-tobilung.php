...
<head>
	...
	<title>Walai Tobilung - Majlis Daerah Kota Marudu</title>
	...
	<meta name="description" content="Walai Tobilung di Kota Marudu – rumah budaya Tobilung yang menampilkan warisan dan seni budaya tempatan.">
</head>
<body>
	...
	<main class="main-content">
		<div class="page-title">Walai Tobilung</div>
		...
		<section class="intro-grid">
			<div>
				...
				<div class="info-card">
					...
					Aktiviti: Lawatan budaya, fotografi, pembelajaran warisan Tobilung.<br>
					Waktu sesuai: Sepanjang hari (ikut waktu operasi).
				</div>
			</div>
			...
			<article class="content-card">
				<h2>Pengenalan</h2>
				<p>
					Walai Tobilung merupakan rumah budaya yang memelihara warisan masyarakat Tobilung
					dengan paparan seni bina tradisi, kraf tangan dan artefak budaya. Lokasi ini sesuai
					untuk aktiviti pembelajaran serta penghayatan budaya tempatan.
				</p>
				<ul>
					<li>Pameran budaya dan kraf tradisional</li>
					<li>Persekitaran landskap yang indah</li>
					<li>Spot fotografi yang menarik</li>
				</ul>
				<p>
					Hormati peraturan lawatan dan jaga kebersihan kawasan untuk kesejahteraan bersama.
				</p>
			</article>
		</section>
		...
		<section class="map-card" aria-label="Lokasi di Google Maps">
			<div class="map-responsive">
				<iframe
					src="https://www.google.com/maps?q=Walai%20Tobilung%20Kota%20Marudu&output=embed"
					loading="lazy"
					referrerpolicy="no-referrer-when-downgrade"
					allowfullscreen
					title="Peta Walai Tobilung">
				</iframe>
			</div>
		</section>
	</main>
